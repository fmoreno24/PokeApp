package com.asesoftware.previsora.autogestion.database.generatebackup
...
class RoomBackup {
    companion object {
        ...
        //private lateinit var INTERNAL_DATABASE_PATH: File
        private lateinit var DATABASE_FILE: File
        private lateinit var mPath: File
    }
    ...
    private fun initRoomBackup(): Boolean {
        ...
        dbName = roomDatabase!!.openHelper.databaseName.toString()
        ...
        //INTERNAL_DATABASE_PATH = File("${context!!.get}/databases/")
